...
public class DeferredAssetLoaderNew : MonoBehaviour
{
    ...
    {
        string directoryPath = Path.GetDirectoryName(materialBundleUrl);
        string lowQualityBundleUrl = Path.Combine(directoryPath, $"{materialName.Replace(' ', '_')}.lowquality");
    ...
    {
        string directoryPath = Path.GetDirectoryName(materialBundleUrl);
        string highQualityBundleUrl = Path.Combine(directoryPath, $"{materialName.Replace(' ', '_')}.highquality");
        ...
        {
            Debug.LogWarning($"Low quality texture bundle not found: {highQualityBundleUrl}");
        }
    }
